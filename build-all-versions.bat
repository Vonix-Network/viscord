...
copy "forge-1.20.1-47.4.0-mdk\build\libs\viscord-1.0.0.jar" "Universal-Build\viscord-1.0.0-forge-1.20.1.jar"
...
copy "forge-1.21.1-52.1.0-mdk\build\libs\viscord-1.0.0.jar" "Universal-Build\viscord-1.0.0-forge-1.21.1.jar"
