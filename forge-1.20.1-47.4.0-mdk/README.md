# Viscord - Bidirectional Minecraft-Discord Chat Integration (Forge 1.20.1)

A powerful Forge mod for Minecraft 1.20.1 that provides seamless bidirectional communication between Minecraft servers and Discord channels. Perfect for multi-server communities that want to share a single Discord chat channel!
