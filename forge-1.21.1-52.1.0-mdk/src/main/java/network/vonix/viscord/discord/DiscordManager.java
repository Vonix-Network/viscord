...
public class DiscordManager {
    ...
    public void initialize(MinecraftServer server) {
        ...
        try {
            playerPreferences = new PlayerPreferences(net.minecraftforge.fml.loading.FMLPaths.CONFIGDIR.get());
            ...
            if (Config.ENABLE_ACCOUNT_LINKING.get()) {
                try {
                    ...
                    Viscord.LOGGER.error("[Discord] Failed to initialize account linking. " +
                            ...
                            server != null ? net.minecraftforge.fml.loading.FMLPaths.CONFIGDIR.get() : "unknown",
                            linkingError);
                    ...
                    if (rawFormat.contains("[Discord]") && inviteUrl != null && !inviteUrl.isEmpty()) {
                        ...
                        finalComponent.append(Component.literal("[Discord]")
                                .setStyle(Style.EMPTY
                                        .withColor(TextColor.fromLegacyFormat(ChatFormatting.AQUA)) // §b
