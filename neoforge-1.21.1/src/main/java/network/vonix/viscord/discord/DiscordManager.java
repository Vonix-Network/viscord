...
public class DiscordManager {
    ...
    public void initialize(MinecraftServer server) {
        ...
        try {
            playerPreferences = new PlayerPreferences(net.neoforged.fml.loading.FMLPaths.CONFIGDIR.get());
            ...
            if (Config.ENABLE_ACCOUNT_LINKING.get()) {
                try {
                    ...
                    Viscord.LOGGER.error("[Discord] Failed to initialize account linking. " +
                            ...
                            server != null ? net.neoforged.fml.loading.FMLPaths.CONFIGDIR.get() : "unknown",
                            linkingError);
